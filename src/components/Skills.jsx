...
const Skills = () => {
  return (
    <div name="skills" className=" w-full h-auto text-gray-300 ">
      {/* container  */}
      <div className="container mx-auto p-4 flex flex-col jus  w-full h-full  ">
        ...
        <div className="w-full grid grid-cols-2 tablet:grid-cols-4 gap-4 text-center  py-8  "  >
          <div className="shadow-md shadow-[#000000] hover:scale-110 duration-500 border border-pink-600 border-spacing-6  rounded " data-aos="fade-down" data-aos-duration="1200"  data-aos-delay="350" >
            <img className="w-20 py-4 mx-auto" src={HTML} alt="HTML icon" />
            <p className="my-4">HTML</p>
          </div>
          <div className="shadow-md shadow-[#000000] hover:scale-110 duration-500 border border-pink-600 border-spacing-6  rounded " data-aos="fade-down" data-aos-duration="1200"  data-aos-delay="450">
            <img className="w-20 py-4 mx-auto" src={CSS} alt="CSS icon" />
            <p className="my-4">CSS</p>
          </div>
          <div className="shadow-md shadow-[#000000] pt-4 hover:scale-110 duration-500 border border-pink-600 border-spacing-6  rounded " data-aos="fade-down" data-aos-duration="1200"  data-aos-delay="550">
            <img className="w-20 mx-auto" src={JS} alt="JS icon" />
            <p className="my-4">JavaScript</p>
          </div>
          <div className="shadow-md shadow-[#000000] hover:scale-110 duration-500 border border-pink-600 border-spacing-6  rounded " data-aos="fade-down" data-aos-duration="1200"  data-aos-delay="650">
            <img
